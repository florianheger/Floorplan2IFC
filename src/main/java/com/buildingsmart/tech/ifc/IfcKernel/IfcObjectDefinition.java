...
public abstract class IfcObjectDefinition extends IfcRoot implements IfcDefinitionSelect
{
	...
	@MaxLength(1)
	@JsonIgnore
	private Set<IfcRelNests> nests = new HashSet<>();
	...
	private Set<IfcRelNests> isNestedBy = new HashSet<>();
	...
	private Set<IfcRelAggregates> isDecomposedBy = new HashSet<>();
	...
	@MaxLength(1)
	@JsonIgnore
	private Set<IfcRelAggregates> decomposes = new HashSet<>();
