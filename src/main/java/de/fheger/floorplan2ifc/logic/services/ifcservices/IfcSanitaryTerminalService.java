...
public class IfcSanitaryTerminalService extends IfcService<IfcSanitaryTerminal, SanitaryTerminalNode> {
    protected IfcSanitaryTerminalService(FindIfcEntityService findIfcEntityService, IAddAttributesService<IfcSanitaryTerminal, SanitaryTerminalNode> addAttributes) {
